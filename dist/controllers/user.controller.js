...
var UserControllerClass = /** @class */ (function () {
    ...
    UserControllerClass.prototype.createUser = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = req.body;
                        user.color = db_1.COLORS[(0, functions_1.getRandomBtnRange)(db_1.COLORS.length)];
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        console.log({ user: user });
                        return [4 /*yield*/, user_service_1.UserService.createUser(user)];
                    case 2:
                        _a.sent();
